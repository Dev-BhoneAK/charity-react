...
const MainSlider = () => {
    ...
    const settings = {
        ...
        nextArrow: <SampleNextArrow customProps={{color: 'red'}} customClasses="custom-next arrow-button d-flex align-items-center justify-content-center"/>,
            ...
            <div className="single-carousel">
                <Slider {...settings}>
                    <div className="slider-container position-relative">
                        <img src="/assets/images/flood.jpg" alt="" className="full-height"/>
                        <div className="content-action">
                            <h1 className="custom-header-lg">Climate Change, Global Threat</h1>
                    ...
                    <div className="slider-container position-relative">
                        <img src="/assets/images/pollution.jpg" alt="" className="full-height"/>
                        <div className="content-action">
                            <h1 className="custom-header-lg">Ocean Pollution, Climate Change</h1>
                            <p className="custom-para mb-3">
                                We are here consectetur quibusdam ipsum deleniti minima cum.
                            </p>
                            <button
                    ...
                    <div className="slider-container position-relative">
                    <img src="/assets/images/hands.jpeg" alt="" className="full-height"/>
                    <div className="content-action">
