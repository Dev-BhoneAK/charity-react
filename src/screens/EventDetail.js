                ...
                <div className="container my-5">
                    <div className="row">
                        <div className="col-md-12">
                            <div className="img-container position-relative">
                                ...
                                />
                                <div
                                    className="category-date-container text-center px-lg-4 py-lg-3 px-3 py-2 position-absolute top-0 rounded-border"
                                >
                    ...
                    <div className="row my-5">
                        ...
                        <div className="col-md-4">
                            <div
                                className="info-card-container d-flex align-items-center justify-content-center mb-3 px-2 pt-5 pb-3"
                            >
                                <div
                                ...
                                >
                                    ...
                                    <ul>
                                        ...
                                        <li className="event-info-list">
                                            <p>Date: <span>{formatDate(event?.date, 'long')}</span></p>
                                        </li>
                                        <li className="event-info-list">
...
const mapStateToProps = ({events, loading}, props) => {
    ...
    const eventIndex = Object.keys(events).filter(eventIdex => events[eventIdex].id == event_id);
